...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    categroy_slug: Schema.Attribute.UID<'name'>;
...
export interface ApiContactUsContactUs extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Form submissions from contact page';
    displayName: 'Contact Us';
    pluralName: 'contact-entries';
...
export interface ApiFooterFooter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    brand_info: Schema.Attribute.Component<'brand-info.brand-info', false>;
    columns: Schema.Attribute.Component<'footer.columns', true>;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    social: Schema.Attribute.Component<'footer.social', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    advertising_section: Schema.Attribute.Component<
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    current_price: Schema.Attribute.Component<'product.price', false>;
    description: Schema.Attribute.Text;
    ...
    publishedAt: Schema.Attribute.DateTime;
    reviewRating: Schema.Attribute.Component<'product.review-rating', true>;
    slug: Schema.Attribute.UID<'name'>;
    sub_categories: Schema.Attribute.Relation<
      'manyToMany',
      'api::sub-category.sub-category'
...
export interface ApiSubCategorySubCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    products: Schema.Attribute.Relation<'manyToMany', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    subCategory_slug: Schema.Attribute.UID<'name'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
